...
<div class="flex items-center gap-2">
     ...
     <!-- Label -->
     <span class="text-lg font-medium"><slot></slot></span>
    ...
    <div 
        class="relative w-160 h-40 overflow-hidden "
        @touchstart="onTouchStart" 
        @touchmove="onTouchMove" 
        @touchend="onTouchEnd">
    <ul 
        ref="listRef"
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-left transition-transform duration-500 ease-out"
